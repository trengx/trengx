...
def op1 (G, in1_id=None, in1_name=None, in1_value=None, in1_grad=0, in2_id=None, in2_name=None, in2_value=None, in2_grad=0, op_name=None, out_name=None, out_value=None, out_grad=0):
    # Generate a new UUID if no id is provided for in1
    if in1_id == None:
...
def op2 (G, in_id=None, in_name=None, in_value=None, in_grad=0, op_name=None, out_name=None, out_value=None, out_grad=0):
